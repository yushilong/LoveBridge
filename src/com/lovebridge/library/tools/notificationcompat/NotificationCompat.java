...
public class NotificationCompat {
    ...
    public static class Builder {
         ...
         * presenting <code>when</code> as a timestamp, the notification will
        ...
        /**
         * Set the relative priority for this notification. Priority is an
         * indication of how much of the user's valuable attention should be
         * consumed by this notification. Low-priority notifications may be
         * hidden from the user in certain situations, while the user might be
         * interrupted for a higher-priority notification. The system will make

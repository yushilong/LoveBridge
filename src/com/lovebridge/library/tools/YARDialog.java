...
public class YARDialog extends Dialog
{
    ...
    *//**
    ...
    {
        YARDialog b5mDialog = new YARDialog(context, R.layout.dialog_confirm);
        b5mDialog.tv_title.setVisibility(View.GONE);
        return b5mDialog;
    }
    ...
    private void init(Context context)
    {
        ...
        bt_left = (Button) view.findViewById(R.id.bt_dialog_left);
        bt_right = (Button) view.findViewById(R.id.bt_dialog_right);
    ...
    public YARDialog(Context context, boolean cancelable, OnCancelListener cancelListener)
    {
        super(context, cancelable, cancelListener);
        // TODO Auto-generated constructor stub
    }

    public YARDialog(Context context)
    {
        super(context);
        // TODO Auto-generated constructor stub
    }
    ...
    {
        bt_left.setText(leftButtonTextResId);
    }
    ...
    public void setRightButtonText(int RightButtonTextResId)
    {
        bt_right.setText(RightButtonTextResId);
    }

    public void setOnLeftButtonClickListener(android.view.View.OnClickListener onClickListener)
    {
        bt_left.setOnClickListener(onClickListener);
    }

    public void setOnRightButtonClickListener(android.view.View.OnClickListener onClickListener)
    {

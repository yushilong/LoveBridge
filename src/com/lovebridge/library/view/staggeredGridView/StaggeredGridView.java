...
import com.lovebridge.library.view.staggeredGridView.ExtendableListView.ListSavedState;
...
public class StaggeredGridView extends ExtendableListView {
    ...
    private void onColumnSync() {
        ...
        for (int pos = 0; pos < syncPosition; pos++) {
            ...
            if (DBG)
                Log.d(TAG, "onColumnSync position:" + pos + " top:" + top + " bottom:" + bottom + " height:" + height
    ...
    private void setPositionHeightRatio(final int position, final int height) {
        ...
        if (DBG)
            Log.d(TAG, "position:" + position + " width:" + mColumnWidth + " height:" + height + " heightRatio:"
                            + rec.heightRatio);
    }

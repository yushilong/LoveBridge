...
class NotificationCompatIceCreamSandwich {
    @SuppressLint("NewApi")
    static Notification add(Context context, Notification n, CharSequence contentTitle, CharSequence contentText,
                            CharSequence contentInfo, RemoteViews tickerView, int number, PendingIntent contentIntent,
                            PendingIntent fullScreenIntent, Bitmap largeIcon, int mProgressMax, int mProgress,
                            boolean mProgressIndeterminate) {
        Notification.Builder b = new Notification.Builder(context).setSound(n.sound, n.audioStreamType)
                        .setVibrate(n.vibrate).setSmallIcon(n.icon, n.iconLevel).setTicker(n.tickerText, tickerView)
                        .setLights(n.ledARGB, n.ledOnMS, n.ledOffMS)
                        .setOngoing((n.flags & Notification.FLAG_ONGOING_EVENT) != 0)
                        .setOnlyAlertOnce((n.flags & Notification.FLAG_ONLY_ALERT_ONCE) != 0)
                        .setAutoCancel((n.flags & Notification.FLAG_AUTO_CANCEL) != 0).setDefaults(n.defaults)
                        .setContentIntent(contentIntent).setDeleteIntent(n.deleteIntent)
        ...
        if (n.contentView != null) {
            ...
            RemoteViews contentView = applyStandardTemplate(R.layout.notification_template_base, context, n,
                            contentTitle, contentText, contentInfo, number, largeIcon, mProgressMax, mProgress,
    ...
    static RemoteViews applyStandardTemplate(int resId, Context context, Notification n, CharSequence contentTitle,
        ...
        if (contentInfo != null) {
            ...
            if (number > tooBig) {
                contentView.setTextViewText(R.id.info, String.valueOf(Integer.MAX_VALUE));
            } else {
        ...
        if (mProgressMax != 0 || mProgressIndeterminate) {
            contentView.setProgressBar(android.R.id.progress, mProgressMax, mProgress, mProgressIndeterminate);

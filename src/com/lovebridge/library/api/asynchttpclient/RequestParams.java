...
public class RequestParams {
     ...
     * 
     * @param encoding String constant from
     *            {@link org.apache.http.protocol.HTTP}
     */
     ...
     * 
     * @param progressHandler HttpResponseHandler for reporting progress on
     *            entity submit
    ...
    private HttpEntity createJsonStreamerEntity(ResponseHandlerInterface progressHandler) throws IOException {
        JsonStreamerEntity entity = new JsonStreamerEntity(progressHandler, !fileParams.isEmpty()
        ...
        for (ConcurrentHashMap.Entry<String, StreamWrapper> entry : streamParams.entrySet()) {
            ...
            if (stream.inputStream != null) {
                entity.addPart(entry.getKey(), StreamWrapper.newInstance(stream.inputStream, stream.name,
                                stream.contentType, stream.autoClose));
            }
        }
        return entity;
    }

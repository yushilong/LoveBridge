...
import com.lovebridge.library.api.YARModel;

public class NearByPeople extends YARModel implements Parcelable {
	...
	public static final Creator<NearByPeople> CREATOR = new Creator<NearByPeople>() {

...
public class MainActivity extends YARActivity {
    ...
    public void doInitSubViews(View containerView) {
        ...
        defaultNavigationView = LayoutInflater.from(this).inflate(R.layout.yar_navigation, null);
    }
    ...
    public void changeNavigationTitle(int resId) {
        ...
        if (resId == 0) {
            ...
            if (yarBaseFragment.getNavigationTitle() instanceof String) {
                titleTextView.setText(yarBaseFragment.getNavigationTitle() == null ? null : yarBaseFragment
                                .getNavigationTitle().toString());

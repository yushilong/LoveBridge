...
import com.lovebridge.activitys.imagefactory.ImageFactoryActivity;
import com.lovebridge.activitys.imagefactory.ImageFactoryFliter.FilterType;
...
public class PhotoUtils {
     ...
     * @return
     */
    public static Bitmap getIndustry(String text) {
        ...
        Bitmap src = BitmapFactory.decodeResource(MainApplication.getInstance().getResources(),
        ...
        int size = (int) (13 * MainApplication.getInstance().getResources().getDisplayMetrics().density);
        p.setTextSize(size);
